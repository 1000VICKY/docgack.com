<form action="/admin/modifyCheckQuestion" method="post" name="newProjectForm">
    ...
    <p>▼新規設問文の説明文入力</p>
    <p><textarea class="testTextArea form-control input-lg" name="questionText" rows="5"><?php print($questionData[0]->question_text); ?></textarea></p>
    ...
    ?>
        <p>
            ...
            <textarea class="testTextArea form-control input-lg <?php print($nowNumber); ?>" name="choiceList[]" rows="3"><?php print($questionData[0]->choice_list[$i]["choiceText"]); ?></textarea>
        </p>
    <?php } ?>
