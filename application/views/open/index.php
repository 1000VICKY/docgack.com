<div class="innerTemplate">
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <!--//▲▲▲-->
            <!--//▼▼▼ここから問題の解説文を保持-->
            <input type="hidden" class="explanation" name="explanationText" value="<?php print(htmlspecialchars($questionList->explanation_text, ENT_QUOTES)); ?>" />
            <!--//▲▲▲-->
...
<div class="col-md-6 margin-bottom margin-top">
    <?php if((int)$page > 0){ ?>
    <a href="/open/index/<?php print($projectId); ?>/<?php print($page - 1); ?>/previous" class="btn btn-primary btn-group-justified"><<前へ</a>
    <?php } ?>
</div>
<div class="col-md-6 margin-bottom margin-top">
    <?php if($page + 1 <=  count($questionIdList) -1) { ?>
    <a href="/open/index/<?php print($projectId); ?>/<?php print($page + 1); ?>/next" class="btn btn-primary btn-group-justified">次へ>></a>
    <?php } ?>
</div>
